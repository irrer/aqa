...
object Cst extends Logging {
  ...
  /**
    ...
    * interface so that it can tell the user.
    */
  private def getCollimatorCompatiblePhase2PlanForMachine(machine: Machine): Option[Config.PlanFileConfig] = {
  ...
  /**
    ...
    */
  private def getCollimatorCompatibleDailyQAPlanForMachine(machine: Machine): Option[Config.PlanFileConfig] = {
  ...
  /**
    ...
    * existence) or this will return None.
    */
  private def getCollimatorCompatibleGapSkewPlanForMachine(machine: Machine): Option[Config.PlanFileConfig] = {
  ...
  /**
    ...
    * existence) or this will return None.
    */
  private def getCollimatorCompatibleWinstonLutzPlanForMachine(machine: Machine): Option[Config.PlanFileConfig] = {
  ...
  /**
    ...
    * interface so that it can tell the user.
    */
  private def getCollimatorCompatibleLocPlanPairForMachine(machine: Machine): Option[LOCRtplanPair] = {
  ...
  /**
    ...
    */
  def makePlanLOC(machine: Machine, userPK: Long, planSpecification: PlanSpecification): Cst.LOCRtplanPair = {
