...
class MakeRtplanGapSkew extends MakeRtplan {
  override def name: String = "Gap Offset Skew"
  override def planFileProcedureName: String = "GapSkew"

  override def procedure: Procedure = Procedure.ProcOfGapSkew.get
