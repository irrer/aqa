...
object Procedure {
  class ProcedureTable(tag: Tag) extends Table[Procedure](tag, "procedure") {
    ...
    def supportingUserFK = foreignKey("userPKConstraint", supportingUserPK, User.query)(_.userPK, onDelete = ForeignKeyAction.Restrict, onUpdate = ForeignKeyAction.Cascade)
  }
