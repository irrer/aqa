...
/**
  ...
  */
class SSSNCImport(extendedData: ExtendedData, monthly: WLMonthly, collimator: WLCollimator, table: WLTable) extends SSSheet {
  ...
  private def makeRow5: Elem = {
    <tr>
      ...
      {toHtml(table.get_Table_X_Optimized - monthly.isoX) /*  C5  */}
      {blankCell /*                                           D5  */}
    </tr>
  }
  ...
  private def makeRow6: Elem = {
    <tr>
      ...
      {toHtml(table.get_Table_Z_Optimized - monthly.isoZ) /*  C6  */}
      {blankCell /*                                           D6  */}
    </tr>
  }
  ...
  private def makeRow8: Elem = {
    <tr>
      ...
      {toHtml(monthly.collGantryMisalign) /*                  C8  */}
      {blankCell /*                                           D8  */}
    </tr>
  }
  ...
  private def makeRow10: Elem = {
    <tr>
      ...
      {toHtml(Math.sqrt(table.get_RSquared_Optimized)) /*     C10  */}
      {blankCell /*                                           D10  */}
    </tr>
  }
  ...
  private def makeRow11: Elem = {
    <tr>
      ...
      {toHtml(monthly.gantryIsocentricity) /*                 C11  */}
      {blankCell /*                                           D11  */}
    </tr>
  }
