...
case class WLGradientHTML(extendedData: ExtendedData, isoCheck: WLIsoCheck, isoTable: WLIsoTable, collimator: WLCollimator) extends Logging {
  ...
  def makeHtml(): Elem = {
    ...
    val isoTableImageIsoTableXIsoTableZ = {
